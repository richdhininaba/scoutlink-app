...
function buildPlayerNav(navId, activeLabel) {
  ...
  var items = [
    ...
    { label: 'Report a Concern', href: '/report-a-concern', icon: 'flag' },
  ...
  var iconSvgs = {
    ...
    'flag': '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width:18px;height:18px;flex-shrink:0"><path d="M5 5a5 5 0 0 1 7 0a5 5 0 0 0 7 0v9a5 5 0 0 1-7 0a5 5 0 0 0-7 0v-9z"/><path d="M5 21v-7"/></svg>',
