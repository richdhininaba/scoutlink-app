...
var STRATEX_NAV_ITEMS = [
  ...
  {label:'Report a Concern', href:'/report-a-concern', icon:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="18" height="18"><path d="M5 5a5 5 0 0 1 7 0a5 5 0 0 0 7 0v9a5 5 0 0 1-7 0a5 5 0 0 0-7 0v-9z"/><path d="M5 21v-7"/></svg>'},
