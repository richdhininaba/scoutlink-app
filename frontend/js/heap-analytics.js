...
(function () {
  ...
  function userProps(ctx) {
    ...
    return {
      ...
      TeamName: safe(pick(u, ['teamName', 'team_name', 'scout_team_name'])),
      LeagueName: safe(pick(u, ['league_name', 'league'])),
      LeagueFullTimeUrl: safe(pick(u, ['league_fulltime_url', 'fulltime_url'])),
