...
(function () {
  ...
  function loadAll() {
    loadScript('dataMediaGuardV1Script','data-media-guard-v1.js','/frontend/js/data-media-guard-v1.js');
    loadScript('scoringV4ClientScript','scoring-v4-client.js','/frontend/js/scoring-v4-client.js');
    loadScript('playerInitialsV1Script','player-initials-v1.js','/frontend/js/player-initials-v1.js');

    if (isExperienceRoute()) {
      loadScript('experienceShellV7Script','experience-shell-v1.js','/frontend/js/experience-shell-v1.js');
    }
    if (isCoachRuntimeRoute()) {
      loadStylesheet('coachLayoutCoreV1Css','../css/coach-layout-core-v1.css','/frontend/css/coach-layout-core-v1.css');
    }
    if (isScoutRuntimeRoute()) {
      loadStylesheet('scoutPredictionOverlaysV2Css','../css/scout-prediction-overlays-v2.css','/frontend/css/scout-prediction-overlays-v2.css');
      loadScript('scoutPredictionOverlaysV2Script','scout-prediction-overlays-v2.js','/frontend/js/scout-prediction-overlays-v2.js');
      loadStylesheet('scoutExperienceCoreV2Css','../css/scout-experience-core-v2.css','/frontend/css/scout-experience-core-v2.css');
      loadScript('scoutExperienceCoreV2Script','scout-experience-core-v2.js','/frontend/js/scout-experience-core-v2.js');
      loadScript('scoutScoringV4Script','scout-scoring-v4.js','/frontend/js/scout-scoring-v4.js');
    }
    if (isDemo()) {
      loadScript('demoScoringV4AuthoritativeScript','demo-scoring-v4-authoritative.js','/frontend/js/demo-scoring-v4-authoritative.js');
      loadScript('demoScoringV4Script','demo-scoring-v4.js','/frontend/js/demo-scoring-v4.js');
    }
    if (isProfileRoute()) {
      loadScript('scoutProfileRuntimeV1Script','scout-profile-runtime-v1.js','/frontend/js/scout-profile-runtime-v1.js');
      loadScript('coachProfileV4OutputFixesScript','coach-profile-v4-output-fixes.js','/frontend/js/coach-profile-v4-output-fixes.js');
    }
  }
