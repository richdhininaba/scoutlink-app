...
(function () {
  ...
  var ASSET_VERSION = '20260822-final-scout-cleanup-1';
  ...
  function loadAll() {
    ...
    if (isScoutRuntimeRoute()) {
      ...
      loadScript('scoutFixturesUsageV1Script','scout-fixtures-usage-v1.js','/js/scout-fixtures-usage-v1.js');
      loadScript('scoutChatNotificationsCleanupV1Script','scout-chat-notifications-cleanup-v1.js','/js/scout-chat-notifications-cleanup-v1.js');
    }
    if (isDemo()) {
