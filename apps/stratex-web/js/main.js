...
const CLEAN_ROUTES = {
  ...
  'confirm-password.html':'/confirm-password',
  ...
  'scout-report-concern.html':'/scout/report-a-concern',
  ...
  'scout-player-profile.html':'/player/profile',
...
(function loadSharedWorkspaceRuntime(){
  ...
  script.src='/js/workspace-loading-v1.js?v=1';
  script.defer=true;
